...
public class ResourceDao extends AbstractObrDao {
    ...
    private void openUpdateEntryStatement() {
        StringBuffer queryb = new StringBuffer();
    ...
    private void openHasEntryStatement() {
        StringBuffer queryb = new StringBuffer();
     ...
     */
    private boolean addEntry(Resource resource) {
     ...
     */
    private boolean hasResourceEntry(String resourceID) {
     ...
     */
    private boolean updateEntry(Resource resource) {
     ...
     */
    public boolean updateDictionaryAndWorkflowDate(Resource resource) {
        boolean updated = false;
        try {
            StringBuffer queryb = new StringBuffer();
            queryb.append("UPDATE ");
            ...
            return this.updateDictionaryAndWorkflowDate(resource);
        } catch (SQLException e) {
    ...
    private void openResetDictionaryStatement() {
        StringBuffer queryb = new StringBuffer();
        queryb.append("UPDATE ");
        queryb.append(this.getTableSQLName());
    ...
    private void openUpdateNumberOfElementAndDateStatement() {
        StringBuffer queryb = new StringBuffer();
        queryb.append("UPDATE ");
        queryb.append(this.getTableSQLName());
     ...
     */
    private ArrayList<Resource> getAllResources() {
    ...
    private void openGetDictioanryIDStatement() {
        StringBuffer queryb = new StringBuffer();
     ...
     */
    private int getDictionaryId(String resourceID) {
        int dictionaryID = -1;
        try {
     ...
     * @return int - id .
     */
    private int getResourceIdKey(String resourceID) {
        int id = -1;
        try {
            hasEntryStatement.setString(1, resourceID);
            ResultSet rSet = this.executeSQLQuery(hasEntryStatement);
