...
public class Structure {
    ...
    private final HashMap<String, String> contexts;
    private final String[] itemKeys;

    private final HashMap<String, Double> weights;

    private final HashMap<String, String> ontoIds;
    ...
    public Double getWeight(String contextName) {
        if (this.weights.containsKey(contextName)) {
            return this.weights.get(contextName);
        } else {
    ...
    public String getOntoID(String contextName) {
        if (this.ontoIds.containsKey(contextName)) {
            return this.ontoIds.get(contextName);
        } else {
            logger.error("ContextName: " + contextName + " doesn't exits in the structure.");
            return "";
        }
