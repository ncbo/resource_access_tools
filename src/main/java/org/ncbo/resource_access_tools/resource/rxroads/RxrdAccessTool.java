...
public class RxrdAccessTool extends ResourceAccessTool {
    ...
    private static final String[] RXRD_ITEMKEYS = {"title"};
    private static final Double[] RXRD_WEIGHTS = {1.0};

    private static final Structure RXRD_STRUCTURE = new Structure(RXRD_ITEMKEYS, RXRD_RESOURCEID, RXRD_WEIGHTS);
    ...
    public String mainContextDescriptor() {
        String RXRD_MAIN_ITEMKEY = "title";
    ...
    private int updates() {
        ...
        String unique_field_column = "rxrd_title";
    ...
    private void openGetElementListStatement() {
     ...
     */
    private HashSet<Integer> getElementList() {
    ...
    private void openGetElementDataStatement() {
        StringBuffer queryb = new StringBuffer();
     ...
     */
    private Element getElementData(Integer localElementID, Structure basicStructure) {
    ...
    private void openGetGrantIdsByFiscalYearStatement() {
        StringBuffer queryb = new StringBuffer();
     ...
     */
    private HashSet<Integer> getGrantIdsByFiscalYear(int fiscalYear) {
    ...
    private void openGetFundingAmountByGrantAndYearStatement() {
        StringBuffer queryb = new StringBuffer();
        queryb.append("SELECT id FROM " + this.getTableSQLName() + " WHERE fiscal_year=? AND GROUP BY investigator_id, title, summary;");
    ...
    private void openGetObrLocalElementIdStatement() {
        StringBuffer queryb = new StringBuffer();
     ...
     */
    private int getObrLocalElementId(int localElementID) {
     ...
     */
    private PreparedStatement prepareSQLStatement(String query) {
        try {
     ...
     */
    private ResultSet executeSQLQuery(PreparedStatement stmt) throws SQLException {
        ResultSet rSet;
        try {
    ...
    private String getTableSQLName() {
        String tableSQLName = "innolyst_grants";
        return tableSQLName;
    }
