...
public class ReactomeAccessTool extends ResourceAccessTool {
    ...
    private static final Structure REAC_STRUCTURE = new Structure(REAC_ITEMKEYS, REAC_RESOURCEID, REAC_WEIGHTS, REAC_ONTOIDS);
     ...
     */
    private HashSet<Long> getLocalElementIds() {
