...
public class MicadAccessTool extends ResourceAccessTool {
    ...
    private static final Structure MICAD_STRUCTURE = new Structure(MICAD_ITEMKEYS, MICAD_RESOURCEID, MICAD_WEIGHTS, MICAD_ONTOIDS);
    private static final String MICAD_MAIN_ITEMKEY = "Name";
     ...
     */
    private String[][] getLocalElementIds() {
