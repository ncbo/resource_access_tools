...
public class SmdAccessTool extends ResourceAccessTool {
    ...
    private static final String PERL_SCRIPT_FILE = new File(SmdAccessTool.class.getResource("smdwebservice.pl").getFile()).getAbsolutePath();
    ...
    private int updateAllElements() {
        ...
        HashMap<String, String> organismMap = getOrganismsMap();
     ...
     * @return Process
     */
    private static Process executePerlCommand(String command) {
