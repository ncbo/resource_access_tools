 ...
 */
package org.ncbo.resource_access_tools.resource.nif.ctddisease;
...
public class CTDDAccessTool extends AbstractNifResourceAccessTool {
    ...
    private static final String NAME = "CTD Disease (via NIF)";
    private static final String RESOURCEID = "CTDD";
    ...
    private static final String[] ITEMKEYS = {"DiseaseName", "AltDiseaseIDs",
            "Definition", "ParentIDs", "TreeNumbers", "ParentTreeNumbers",
