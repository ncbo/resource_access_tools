...
public class CcDBAccessTool extends AbstractNifResourceAccessTool {
    ...
    private static final Structure CCDB_STRUCTURE = new Structure(CCDB_ITEMKEYS, CCDB_RESOURCEID, CCDB_WEIGHTS, CCDB_ONTOIDS);
    // Constant
    ...
    public String mainContextDescriptor() {
        String CCDB_MAIN_ITEMKEY = "ProjectName";
