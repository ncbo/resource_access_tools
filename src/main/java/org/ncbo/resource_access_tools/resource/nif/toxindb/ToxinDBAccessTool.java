...
public class ToxinDBAccessTool extends AbstractNifResourceAccessTool {
    ...
    private static final Structure TOXIN_STRUCTURE = new Structure(TOXIN_ITEMKEYS, TOXIN_RESOURCEID, TOXIN_WEIGHTS, TOXIN_ONTOIDS);
    ...
    public ToxinDBAccessTool() {
        ...
        Map<String, String> localOntologyIDMap = createLocalOntologyIDMap(TOXIN_STRUCTURE);
    }
    ...
    public String mainContextDescriptor() {
        String TOXIN_MAIN_ITEMKEY = "toxinName";
