 ...
 */
package org.ncbo.resource_access_tools.resource.nif.ctdpathway;
...
public class CTDPAccessTool extends AbstractNifResourceAccessTool {
    ...
    private static final String NAME = "CTD Pathway (via NIF)";
    private static final String RESOURCEID = "CTDP";
    ...
    private static final String[] ITEMKEYS = {"Pathway"};
    private static final Double[] WEIGHTS = {1.0};
    private static final String[] ONTOIDS = {Structure.FOR_CONCEPT_RECOGNITION};
