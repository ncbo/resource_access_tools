...
public class ModelDBAccessTool extends AbstractNifResourceAccessTool {
    ...
    private static final Structure MDB_STRUCTURE = new Structure(MDB_ITEMKEYS, MDB_RESOURCEID, MDB_WEIGHTS, MDB_ONTOIDS);
    // Constants
    ...
    public ModelDBAccessTool() {
        ...
        Map<String, String> localOntologyIDMap = createLocalOntologyIDMap(MDB_STRUCTURE);
    }
