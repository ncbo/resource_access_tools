...
public class GEMMAAccessTool extends AbstractNifResourceAccessTool {
    ...
    private static final Structure GEMMA_STRUCTURE = new Structure(GEMMA_ITEMKEYS, GEMMA_RESOURCEID, GEMMA_WEIGHTS, GEMMA_ONTOIDS);
    // Constant
    ...
    public GEMMAAccessTool() {
        ...
        Map<String, String> localOntologyIDMap = createLocalOntologyIDMap(GEMMA_STRUCTURE);
    }
    ...
    public String mainContextDescriptor() {
        String GEMMA_MAIN_ITEMKEY = "Source";
