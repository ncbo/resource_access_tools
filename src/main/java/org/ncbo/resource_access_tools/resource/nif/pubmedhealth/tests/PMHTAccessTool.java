...
public class PMHTAccessTool extends AbstractNifResourceAccessTool {
    ...
    private static final Structure PMH_STRUCTURE = new Structure(PMH_ITEMKEYS, PMH_RESOURCEID, PMH_WEIGHTS, PMH_ONTOIDS);
    // Constant
    ...
    public PMHTAccessTool() {
        ...
        Map<String, String> localOntologyIDMap = createLocalOntologyIDMap(PMH_STRUCTURE);
    }
    ...
    public String mainContextDescriptor() {
        String PMH_MAIN_ITEMKEY = "Test_Name";
