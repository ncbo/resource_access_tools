...
class GetPgkbDrugList implements StringHelper {

    // Logger for this class
    private static final Logger logger = Logger.getLogger(GetPgkbDrugList.class);
    ...
    //attributes
    private static final String COMMAND = "perl " + PERL_SCRIPT_PATH + " 5";

    private final HashSet<String> drugList = new HashSet<String>();    //<accession Id of drug in PharmGKB are localElementId>
