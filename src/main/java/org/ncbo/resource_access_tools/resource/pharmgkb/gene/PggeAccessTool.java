...
public class PggeAccessTool extends ResourceAccessTool {
    ...
    private static final Structure PGGE_STRUCTURE = new Structure(PGGE_ITEMKEYS, PGGE_RESOURCEID, PGGE_WEIGHTS);
    ...
    public String mainContextDescriptor() {
        String PGGE_MAIN_ITEMKEY = "geneName";
     ...
     */
    private Element getOneGeneData(String elementLocalId) {
