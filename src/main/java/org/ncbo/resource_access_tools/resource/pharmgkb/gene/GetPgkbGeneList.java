...
class GetPgkbGeneList implements StringHelper {

    // Logger for this class
    private static final Logger logger = Logger.getLogger(GetPgkbGeneList.class);
    ...
    private static final String COMMAND_0 = "perl " + PERL_SCRIPT_PATH + " 0";
    private static final String COMMAND_1 = "perl " + PERL_SCRIPT_PATH + " 1";
    private final HashSet<String> geneList = new HashSet<String>();    //<accession Id of gene in PharmGKB are localElementId>
