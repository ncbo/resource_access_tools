...
public class GetPgkbDrugData implements StringHelper {
    ...
    private static final Logger logger = Logger.getLogger(GetPgkbDrugData.class);
    //attributes
    private static final String PERL_SCRIPT_PATH = new File(GetPgkbDrugData.class.getResource("drugs.pl").getFile()).getAbsolutePath();
    private static final String COMMAND = "perl " + PERL_SCRIPT_PATH;
    private Hashtable<String, Hashtable<String, Hashtable<Integer, String>>> drugData = new Hashtable<String, Hashtable<String, Hashtable<Integer, String>>>();    //<geneAccession, Hashtable of attribut-value couple>
    private final Hashtable<String, Hashtable<Integer, String>> drugAttribute = new Hashtable<String, Hashtable<Integer, String>>();    //<attributName, value> (a value could be a map)
