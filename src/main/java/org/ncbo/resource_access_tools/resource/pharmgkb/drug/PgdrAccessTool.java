...
public class PgdrAccessTool extends ResourceAccessTool {
    ...
    private static final Structure PGDR_STRUCTURE = new Structure(PGDR_ITEMKEYS, PGDR_RESOURCEID, PGDR_WEIGHTS);
    ...
    public String mainContextDescriptor() {
        String PGDR_MAIN_ITEMKEY = "drugName";
     ...
     */
    private Element getOneDrugData(String elementLocalId) {
