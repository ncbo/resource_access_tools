...
public class GetPgkbDiseaseData implements StringHelper {
    ...
    private static final Logger logger = Logger.getLogger(GetPgkbDiseaseData.class);
    //attributes
    private static final String PERL_SCRIPT_PATH = new File(GetPgkbDiseaseData.class.getResource("diseases.pl").getFile()).getAbsolutePath();

    private static final String COMMAND = "perl " + PERL_SCRIPT_PATH;
    private Hashtable<String, Hashtable<String, Hashtable<Integer, String>>> diseaseData = new Hashtable<String, Hashtable<String, Hashtable<Integer, String>>>();    //<diseaseAccession, Hashtable of attribut-value couple>
    private final Hashtable<String, Hashtable<Integer, String>> diseaseAttribute = new Hashtable<String, Hashtable<Integer, String>>();    //<attributName, value> (a value could be a map)
    private Hashtable<Integer, String> attributeValues = new Hashtable<Integer, String>();
