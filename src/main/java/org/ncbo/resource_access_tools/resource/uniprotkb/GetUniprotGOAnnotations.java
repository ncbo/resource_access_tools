 ...
 * @created 21-Nov-2008
 */
class GetUniprotGOAnnotations implements StringHelper {

    // Logger for this class
    private static final Logger logger = Logger.getLogger(GetUniprotGOAnnotations.class);
    ...
    private final HashSet<Element> ProteinAnnotList = new HashSet<Element>();
    private Hashtable<String, Hashtable<String, String>> allProtAnnot = new Hashtable<String, Hashtable<String, String>>();    //<protAccession, Hashtable of attribut-values couple>
    private Hashtable<String, String> protAnnotAttribute = new Hashtable<String, String>();    //<attributName, value> (a value could be a map)
    private Hashtable<String, String> protAnnotAttribute2 = new Hashtable<String, String>();    //<attributName, value> (a value could be a map)
