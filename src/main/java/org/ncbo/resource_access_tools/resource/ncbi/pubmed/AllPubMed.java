...
class AllPubMed {
    ...
    private static final Logger mylogger = Logger.getLogger("MyLog");
    ...
    private static final String database = "jdbc:mysql://localhost:3306/resource_index";
...
//  static String password = "optra";
     ...
     * return int
     */
    private int updateResourceContent() {

        int nbElements = 0;
        nbElements += eutilsUpdateAll();

        return nbElements;
    }

    private int eutilsUpdateAll() {
        int nbElement = 0;
     ...
     */
    private HashSet<String> getAlllocalUids() {
    ...
    private int updateElementTableWithUIDs(HashSet<String> UIDs)
    ...
    private void addRecord(HashSet<PubMedElement> eleList) {
     ...
     */
    private static Connection getConnection(String url, String loginName, String Password) {
