...
public class PubMedAccessTool extends AbstractNcbiResourceAccessTool {
    ...
    private static final Structure PM_STRUCTURE = new Structure(PM_ITEMKEYS, PM_RESOURCEID, PM_WEIGHTS, PM_ONTOIDS);
    ...
    private static final int START_XML_NUMBER = Integer.parseInt(MessageUtils.getMessage("obr.pm.xml.from"));

    // End processing xml file number
    private static final int END_XML_NUMBER = Integer.parseInt(MessageUtils.getMessage("obr.pm.xml.to"));

    // End processing xml file number
    private static final boolean PROCESS_XML_FILES = Boolean.parseBoolean(MessageUtils.getMessage("obr.pm.process.xml"));

    // lingpipe parser
    private static final MedlineParser medlineParser = new MedlineParser(true);
     ...
     * @return {@link String}
     */
    private String mapMeshHeadingsToLocalConceptIDs(MeshHeadingType[] meshheadingtab) {
     ...
     */
    private int downloadResourceContent() {
    ...
    private class MedlineDbLoader implements MedlineHandler {
        ...
        private final PubMedAccessTool tool;
    ...
    private class PubMedElement {
        ...
        final PubMedAccessTool eltPMTool;
        final String eltPMID;
     ...
     * @return
     */
    private String mapMeshHeadingsToLocalConceptIDs(MeshHeading[] meshheadingtab) {
        HashSet<String> meshHeadings = new HashSet<String>();
