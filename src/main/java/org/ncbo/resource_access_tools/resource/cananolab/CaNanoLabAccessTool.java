...
//    private static final String CANANO_ELT_URL = CaNanoLabUtility.getCananoLabElementURL();
    ...
    private static final Structure CANANO_STRUCTURE = new Structure(CANANO_ITEMKEYS, CANANOLAB_RESOURCE_ID,
            CANANO_WEIGHTS, CANANO_ONTOIDS);

    private static final String CANANO_MAIN_ITEMKEY = CANANO_ITEMKEYS[4];
