...
public class GrantsAccessTool extends ResourceAccessTool {
    ...
    private static final Structure GRANTS_STRUCTURE = new Structure(GRANTS_ITEMKEYS, GRANTS_RESOURCEID, GRANTS_WEIGHTS);
    ...
    private HashSet<Integer> localElementIDList = new HashSet<Integer>();
...
//		}
    ...
    public String mainContextDescriptor() {
        String GRANTS_MAIN_ITEMKEY = "title";
    ...
    private String getTableSQLName() {
        String tableSQLName = "GRANTS_1972_2009";
        return tableSQLName;
    }
