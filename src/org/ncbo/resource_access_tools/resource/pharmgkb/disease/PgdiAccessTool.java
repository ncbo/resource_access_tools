...
public class PgdiAccessTool extends ResourceAccessTool {
	...
	private static Structure PGDI_STRUCTURE      = new Structure(PGDI_ITEMKEYS, PGDI_RESOURCEID, PGDI_WEIGHTS);
	private static String PGDI_MAIN_ITEMKEY      = "diseaseName";
	 ...
	 */
	public HashSet<String> getAllDiseases(){
	 ...
	 */
	public Element getOneDiseaseData(String elementLocalId){
