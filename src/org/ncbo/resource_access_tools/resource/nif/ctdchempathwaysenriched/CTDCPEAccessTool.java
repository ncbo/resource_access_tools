 ...
 */
package org.ncbo.resource_access_tools.resource.nif.ctdchempathwaysenriched;
 ...
 * @author r.malviya
 */
public class CTDCPEAccessTool extends AbstractNifResourceAccessTool {


    private static final String URL = "http://ctdbase.org/";
    private static final String NAME = "CTD ChemPathways Enriched (via NIF)";
    private static final String RESOURCEID = "CTDCPE";
    ...
    private static final String[] ITEMKEYS = {"ChemicalName","ChemicalID", "CasRN","PathwayName", "PValue","CorrectedPValue","TargetMatchQty","TargetTotalQty","BackgroundMatchQty","BackgroundTotalQty"};
    private static final Double[] WEIGHTS = {1.0,0.9,0.8,0.7,0.6,0.5,0.4,0.3,0.2,0.1};
	...
	public void getAllElements() {
        ...
        try{
        	...
        	URL csvFile=new URL("http://ctdbase.org/reports/CTD_chem_pathways_enriched.tsv.gz");
            ...
            while (i.hasNext()) {
                ...
                try {
                    ...
                    logger.error("** PROBLEM ** Problem with id " + myExp.getLocalElementId() + " when populating the OBR_CTDCPE_ET table.", e);
                }

            }
            logger.info(nbElement + " elements added to the OBR_CTDCPE_ET table.");
        }
				}
