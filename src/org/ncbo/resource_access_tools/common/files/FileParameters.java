...
public class FileParameters {
	...
	private static Logger logger = Logger.getLogger(FileParameters.class);

	// Remote host name
	public static final String REMOTE_HOST_DEV2 	= "ncbolabs-dev2";
	
	// Local & remote paths
	public static final String LOCAL_FOLDER 		= "files/";
