...
public class Messages {
	 ...
	 * 
	 * @param name
	 *            Name of the requested <code>ResourceBundle</code>
	 */
	 ...
	 *            Name of the requested <code>ResourceBundle</code>
	 * @param cl
	 *            <code>ClassLoader</code> to use for loading this resource
	 ...
	 * 
	 * @param cl
	 *            The new class loader, or <code>null</code> for the thread
	 ...
	 * 
	 * @param name
	 *            New name of the resource bundle to be retrieved
	 */
	 ...
	 * 
	 * @param key
	 *            Key to the message string to look up
	 */
	 ...
	 *            Key to the message string to look up
	 * @param locale
	 *            Locale used to localize this message
	 */
	 ...
	 * 
	 * @param locale
	 *            Locale used to select the appropriate resource bundle
	 */
